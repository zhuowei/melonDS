...
ConfigEntry ConfigFile[] =
{
    ...
    // MelonRipper
    {"HKKey_RipFrame",   0, &HKKeyMapping[HK_RipFrame],   -1, true},
    {"HKKey_RipFrameX5", 0, &HKKeyMapping[HK_RipFrameX5], -1, true},
    {"HKJoy_RipFrame",   0, &HKJoyMapping[HK_RipFrame],   -1, true},
    {"HKJoy_RipFrameX5", 0, &HKJoyMapping[HK_RipFrameX5], -1, true},
