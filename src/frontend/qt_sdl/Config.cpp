...
ConfigEntry ConfigFile[] =
{
    ...
    // MelonRipper
    {"HKKey_RipFrame",   0, &HKKeyMapping[HK_RipFrame],   -1},
    {"HKKey_RipFrameX5", 0, &HKKeyMapping[HK_RipFrameX5], -1},
    {"HKJoy_RipFrame",   0, &HKJoyMapping[HK_RipFrame],   -1},
    {"HKJoy_RipFrameX5", 0, &HKJoyMapping[HK_RipFrameX5], -1},
